...
async function main() {
  try {
    ...
    const testMembers = [
      { name: 'Test Member One', email: 'test.member.01@test.com' },
      { name: 'Test Member Two', email: 'test.member.02@test.com' },
      { name: 'Test Member Three', email: 'test.member.03@test.com' },
      { name: 'Test Member Four', email: 'test.member.04@test.com' },
      { name: 'Test Member Five', email: 'test.member.05@test.com' },
      { name: 'Test Member Six', email: 'test.member.06@test.com' },
      { name: 'Test Member Seven', email: 'test.member.07@test.com' },
      { name: 'Test Member Eight', email: 'test.member.08@test.com' },
      { name: 'Test Member Nine', email: 'test.member.09@test.com' },
      { name: 'Test Member Ten', email: 'test.member.10@test.com' },
      { name: 'Test Member Eleven', email: 'test.member.11@test.com' },
      { name: 'Test Member Twelve', email: 'test.member.12@test.com' },
      { name: 'Test Member Thirteen', email: 'test.member.13@test.com' },
      { name: 'Test Member Fourteen', email: 'test.member.14@test.com' },
      { name: 'Test Member Fifteen', email: 'test.member.15@test.com' },
    ];
